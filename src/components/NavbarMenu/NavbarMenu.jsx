        ...
        <Navbar>
            <Container>
                <Navbar.Brand as={Link} to="/">
                    <img src="src/assets/logoMin.png" height="auto" width="60px"></img>
                </Navbar.Brand>

                <Nav>
                    <Nav.Link as={Link} to="/menu" className="text-danger mx-5 fw-bolder">
                    ...
                    <Nav.Link as={Link} to="/cart" className="mx-5  fw-bolder">
